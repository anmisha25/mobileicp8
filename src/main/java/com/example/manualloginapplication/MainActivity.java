    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ed1.getText().toString().equals("anmishab@gmail.com") &&
                        ed2.getText().toString().equals("anmishab")) {
                    Toast.makeText(getApplicationContext(),
                            "Redirecting...",Toast.LENGTH_SHORT).show();
                    reDirectToHomePage();
                }else{
                    Toast.makeText(getApplicationContext(), "The password or email is incorrect",Toast.LENGTH_SHORT).show();
                }
            }
        });
